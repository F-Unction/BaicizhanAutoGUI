...
namespace OcrLiteLib
{
    public class OcrLite
    {
        ...
        public OcrResult Detect(byte[] img, int padding, int imgResize, float boxScoreThresh, float boxThresh,
                              float unClipRatio, bool doAngle, bool mostAngle)
        {
            Mat brgSrc = new Mat();
            CvInvoke.Imdecode(img, ImreadModes.Color, brgSrc);//default : BGR
